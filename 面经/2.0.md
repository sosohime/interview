...
- 基础
    ...
    - 浏览器相关
        ...
        - 问: MutationObserver \ IntersectionObserver用过嘛，干嘛的，优势
            - 1
    ...
    - 安全
        ...
        - 问: 登录怎么实现
          - session、jwt
        - 问: 禁用cookie还能保存登录状态吗，明文传递session安全吗
...
每日交互小知识，对于一些关键数据展示，要留意是否提供了便捷的双击选中，如<span>phone13113212345</span>会导致用户双击选中“phone13113212345”，可以使用 &#8203; 做分隔 eg. <span>phone&#8203;13512341243</span>
( Unicode Character 'ZERO WIDTH SPACE' (U+200B). this character is intended for line break control; it has no width, but its presence between two characters does not prevent increased letter spacing in justification)